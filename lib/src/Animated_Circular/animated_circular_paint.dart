...
class AnimatedCircularProgressBarPainter extends CustomPainter {
  ...
  AnimatedCircularProgressBarPainter({
  ...
  @override
  bool shouldRepaint(AnimatedCircularProgressBarPainter oldDelegate) {
